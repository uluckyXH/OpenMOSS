...
COMMAND_REGISTRY: dict[str, CommandMeta] = {
    ...
    "st": CommandMeta(
        ...
        subcommands={
            ...
            "block": SubcommandMeta("标记异常", frozenset({"patrol"})),
    ...
    "score": CommandMeta(
        ...
        group="score",
        subcommands={
            "me": SubcommandMeta("查看我的积分", frozenset({"planner", "executor", "reviewer", "patrol"})),
            "logs": SubcommandMeta("查看积分明细", frozenset({"planner", "executor", "reviewer", "patrol"})),
            "agent-logs": SubcommandMeta("查看指定 Agent 的积分明细", frozenset({"planner", "reviewer", "patrol"})),
