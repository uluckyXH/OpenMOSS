...
export {
  ...
  type ManagedAgentDeployChangesetItem,
  type ManagedAgentDeployPreviewResponse,
  type ManagedAgentDeployScriptConflictDetail,
  type ManagedAgentDeployScriptConflictSnapshot,
  type ManagedAgentDeployScriptInput,
  type ManagedAgentDeployScriptIntent,
  type ManagedAgentDeployScriptResponse,
  type ManagedAgentDeploySelectionInput,
  type ManagedAgentDeploymentChangeType,
  type ManagedAgentDeploymentDismissInput,
  type ManagedAgentDeploymentDismissResponse,
  type ManagedAgentDeploymentMode,
  type ManagedAgentDeploymentPhase,
  type ManagedAgentDeploymentResourceType,
  type ManagedAgentDeploymentSnapshot,
  type ManagedAgentDeploymentSnapshotStatus,
